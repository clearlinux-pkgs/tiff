...
Source0  : https://gitlab.com/libtiff/libtiff/-/archive/v4.7.0/libtiff-v4.7.0.tar.gz
...
%prep
%setup -q -n libtiff-v4.7.0
cd %{_builddir}/libtiff-v4.7.0
pushd ..
cp -a libtiff-v4.7.0 build32
popd
pushd ..
cp -a libtiff-v4.7.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726857992
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libtiff.so.6.1.0
/V3/usr/lib64/libtiffxx.so.6.1.0
/usr/lib64/libtiff.so.6
/usr/lib64/libtiff.so.6.1.0
/usr/lib64/libtiffxx.so.6
/usr/lib64/libtiffxx.so.6.1.0
