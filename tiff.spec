...
Source0  : https://gitlab.com/libtiff/libtiff/-/archive/v4.2.0/libtiff-v4.2.0.tar.gz
...
%prep
%setup -q -n libtiff-v4.2.0
cd %{_builddir}/libtiff-v4.2.0
pushd ..
cp -a libtiff-v4.2.0 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1614373185
...
cp %{_builddir}/libtiff-v4.2.0/COPYRIGHT %{buildroot}/usr/share/package-licenses/tiff/a2f64f2a85f5fd34bda8eb713c3aad008adbb589
pushd ../build32/
%make_install32
